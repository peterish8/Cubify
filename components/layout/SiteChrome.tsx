...
export function SiteHeader({
  ...
  return (
    <header className="sticky top-0 z-40 px-3 pt-3 sm:px-4 sm:pt-4">
      <div className="nav-island mx-auto flex h-14 max-w-6xl items-center justify-between rounded-full px-3 sm:px-5">
  ...
  return (
    <footer className="mt-auto border-t border-border">
      <div className="mx-auto flex max-w-6xl flex-col gap-3 px-4 py-10 sm:flex-row sm:items-center sm:justify-between sm:px-6">
        ...
        <div className="flex items-center gap-3 text-[11px] font-data tracking-wide text-muted-foreground">
