    ...
    variants: [
      {
        ...
        shadeLabel: "Lighter",
        name: "Tokyo Pastel",
        description: "Soft pastel Tokyo lift — milky blue-lavender on ink.",
        swatches: ["#e8ebff", "#cdd6f4", "#a5c4fc", "#1a1b28"],
      },
      {
        id: "tokyo-night",
        shade: "darker",
        shadeLabel: "Darker",
        name: "Tokyo Night",
        description: "Ink blue with lavender and cyan (former lighter).",
      ...
      },
      {
        ...
        shadeLabel: "Deep",
        name: "Tokyo Deeper",
        description: "Same palette, blacker stage and tighter glass.",
        swatches: ["#a9b1d6", "#7aa2f7", "#9d7cd8", "#0d0e14"],
      },
    ],
  },
